...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">Cửa hàng bán đồ điện, điện tử</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex space-x-2">
                        ...
                        {{-- Nếu đã đăng nhập thì hiện Giỏ hàng + Logout --}}
                        @auth
    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>Về chúng tôi</h5>
                    <p>Cửa hàng chuyên cung cấp đồ điện, điện tử chất lượng với giá tốt nhất thị trường.</p>
                </div>
                <div class="col-md-4">
                    <h5>Liên hệ</h5>
            ...
            <div class="text-center">
                &copy; {{ date('Y') }} Cửa hàng đồ điện, điện tử. Tất cả quyền được bảo lưu.
            </div>
        </div>
    </footer>
